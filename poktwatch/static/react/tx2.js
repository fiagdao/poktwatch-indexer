...
function Direction(props) {
  if (props.receiever==props.address) {
    return (
      <td>
    ...
    <td>
      <span className="u-label u-label--xs u-label--warning color-strong text-uppercase text-center w-100 rounded text-nowrap">&nbsp;IN&nbsp;</span>
    </td>
  }
}
