void 0 === jQuery.migrateMute && (jQuery.migrateMute = !0),
    function(e) {
        ...
        e.migrateVersion = "3.0.1", t.console && t.console.log && (e && !/^[12]\./.test(e.fn.jquery) || t.console.log("JQMIGRATE: jQuery 3.0.0+ REQUIRED"), e.migrateWarnings && t.console.log("JQMIGRATE: Migrate plugin loaded multiple times"));
        var o = {};
        ...
        e.fn.size = function() {
            ...
            var n, a, o = u(t),
                i = (a = (n = t) && n.toString(), !e.isArray(n) && a - parseFloat(a) + 1 >= 0);
            return o !== i && r("jQuery.isNumeric() should not be called on constructed objects"), i
        ...
        e.fn.andSelf = function() {
            return r("jQuery.fn.andSelf() is deprecated and removed, use jQuery.fn.addBack()"), S.apply(this, arguments)
        };
        var A = e.Deferred,
            q = [
        ...
        }, e.Deferred.exceptionHook = A.exceptionHook, e
    });